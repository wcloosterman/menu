...
powershell.exe -noprofile -executionpolicy bypass -file C:\BRU\Bloatware-Removal-Utility.ps1 -s -exclude "keyboard","driver","HP Universal Camera Driver","HP Hotkey Support","HP Wireless Button Driver","Microsoft\ Office","Microsoft\.Office" -includelast "HP Client Security Manager","HP Support Assistant" -norestorepoint
	pause
    rem exit
