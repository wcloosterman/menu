# If MFA is needed, import exchange module:
Import-Module ExchangeOnlineManagement

# Usage: ./O365UserLoginHistory.ps1 -AdminName admin@domain.com -Password XXXXXXX
# or WITH MFA: ./O365UserLoginHistory.ps1 -AdminName admin@domain.com -Password XXXXXXX -MFA

# Other details: https://o365reports.com/2019/12/23/export-office-365-users-logon-history-report/?src=technet
# Source: https://gallery.technet.microsoft.com/office/Export-Office-365-Users-d83e98ca
